...
insert into kn_user (id, create_id, create_time, update_id, update_time, email, login_ip, login_name, login_time, name, user_online, password, salt, status) values (1, 0, 1406532246618, null, null, 'admin@kingnode.com', null, 'admin', null, '管理员', 0, '691b14d79bf0fa2215f155235df5e670b64394cc', '7efbd59d9741d34f', 'ENABLE');

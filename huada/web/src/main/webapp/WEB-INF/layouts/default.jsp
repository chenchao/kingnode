...
<script type="text/javascript">
    if(typeof console=="object"){
        if($.browser.safari){
            console.info("%c你如此喜欢阅读代码，家里人知道嘛？不知道没关系，赶紧加入我们吧，我们懂你。http://www.kingnode.com","color: #0677c8; font-size: 18px; font-family: 'Helvetica-Neue', Helvetica, Arial, sans-serif;");
        }else{
            console.info("你如此喜欢阅读代码，家里人知道嘛？不知道没关系，赶紧加入我们吧，我们懂你。http://www.kingnode.com");
        }
    }
</script>
</html>
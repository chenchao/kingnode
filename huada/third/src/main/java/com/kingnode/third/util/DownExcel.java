package com.kingnode.third.util;
...
public class DownExcel{
    ...
    private Map<String,Object> getImportListInfo(Workbook wb,String tip){
        ...
        try{
            ...
            for(int h=0;h<wb.getNumberOfSheets();h++){//获取每个Sheet表
                ...
                if(sheetName.equalsIgnoreCase("ShtDictionary")||sheetName.equalsIgnoreCase("上传excel说明")){
                    continue;
                }
                ...
                if(rowNum==2){//没有数据
                    ...
                    for(int i=2;i<rowNum;i++){
                        ...
                        if("1".equals(tip)){//上传用户
                            ...
                            if(null==c1||null==c3||null==c5||null==c6){//判断不能为空
                                if(tipB==0){
                                    if(tipA>0){
                            ...
                            if(sheetName.equalsIgnoreCase("班次信息")){
                        ...
                        }else if("8".equals(tip)){//CRM考勤班次 考勤地址信息
    ...
    private String getValueByCell(Cell cc){
        ...
        if(null!=cc){
            ...
            if(!Strings.isNullOrEmpty(retuStr)){
